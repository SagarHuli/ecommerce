                ...
                <div class="col-md-4 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center><h5> Price: 67,999.00</h5></center>
                            <a href="cart-add.php?id=1" class="btn btn-primary" id="width_set" >Add to cart</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center><h5>Price: 85,999.00</h5></center>
                            <a href="cart-add.php?id=2" class="btn btn-primary" id="width_set" >Add to cart</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center> <h5>Price: 57,990.00</h5></center>
                            <a href="cart-add.php?id=3" class="btn btn-primary" id="width_set" >Add to cart</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center> <h5>Price: 34,000.00 </h5></center>
                             <a href="cart-add.php?id=4" class="btn btn-primary" id="width_set" >Add to cart</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center><h5>Price: 61.000.00</h5></center>
                           <a href="cart-add.php?id=5" class="btn btn-primary" id="width_set" >Add to cart</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center><h5>Price :21,000.00</h5></center>
                            <a href="cart-add.php?id=6" class="btn btn-primary" id="width_set" >Add to cart</a>
                        </div>
                    </div>
                </div>
            </div>
